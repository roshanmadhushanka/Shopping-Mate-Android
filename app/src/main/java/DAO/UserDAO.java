...
public class UserDAO{
    ...
    public void insert(Server.AsyncWriteCompleteListener listener,UserDTO userDTO){
        ...
        new Server().sendToServer(url, userDetails, listener);
    }
    ...
    public void read(Server.AsyncReadCompleteListener listener, String name, String password){
    ...
    public void read(Server.AsyncReadCompleteListener listener, String userId){
        String url = "http://ynot.esy.es/GetUserDataById.php";
    ...
    public void count(Server.AsyncReadCompleteListener listener){
